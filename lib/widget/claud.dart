...
class AstrologyAnimation extends StatefulWidget {
  @override
  _AstrologyAnimationState createState() => _AstrologyAnimationState();
}

class _AstrologyAnimationState extends State<AstrologyAnimation>
...
//       ),
//     );
//     // Individual orbit animations (moving from left to right)
//     _orbit1Animation = Tween<double>(begin: -351.85.w, end: -150.91).animate(
//       CurvedAnimation(
//         parent: _controller,
//         curve: const Interval(0, 0.4, curve: Curves.easeInOut),
...
//             end: Alignment.bottomCenter,
//             colors: [
//               Color(0xFF7495E8), // #7495E8
//               Color(0xFF0C359E), // #0C359E
//             ],
//           ),
//         ),
//       ),
...
//   Widget _orbit(double height, double top, double left, double angle,
//       double borderWidth, Color color, Animation orbitAnimation) {
//     print('orbitAnimation.value: ${orbitAnimation.value}');
//     return Positioned(
//       top: top.h,
//       left: orbitAnimation.value,
//       // left: -left,
...
//             // color: Colors.red,
//             borderRadius: const BorderRadius.all(
//               Radius.circular(1000), // Quarter circle effect
//             ),
//             border:
//                 Border.all(width: borderWidth, color: color), // Top border only
//           ),
//         ),
//       ),
//     );
